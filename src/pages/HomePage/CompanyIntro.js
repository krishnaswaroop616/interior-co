      ...
      <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div className="bg-transparent/10 backdrop-blur-sm p-8 rounded-lg  order-2 md:order-1">
          ...
          <div className="text-gray-300 text-lg leading-relaxed  space-y-6">
            <p>At <span className="text-orange-300 font-semibold">Foyerbloom</span>, we don't just decorate spaces — we shape environments that resonate with who you are. Whether it’s a modern apartment, a warm family home, or a luxury villa, we believe every space should tell a story — <span className="italic">your story</span>.</p>
